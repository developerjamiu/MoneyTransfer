...
public class AppConfig {
    ...
    //public static String URL_LOGIN = "http://192.168.43.137:5000/api/auth";
    public static String URL_LOGIN = "http://10.0.2.2:5000/api/auth";

    // Server User Register Url
    //public static String URL_REGISTER = "http://192.168.43.137:5000/api/users";
    public static String URL_REGISTER = "http://10.0.2.2:5000/api/users";

    // Server User Info Url
    //public static String URL_ME = "http://192.168.43.137:5000/api/users/me";
    public static String URL_ME = "http://10.0.2.2:5000/api/users/me";

    // Server Fund Wallet Url
    //public static String URL_FUND = "http://192.168.43.137:5000/api/wallet/fund";
    public static String URL_FUND = "http://10.0.2.2:5000/api/wallet/fund";

    // Server Transfer Money Url
    //public static String URL_TRANSFER = "http://192.168.43.137:5000/api/wallet/transfer";
    public static String URL_TRANSFER = "http://10.0.2.2:5000/api/wallet/transfer";

    // Server Fetch Recipient Money Url
    //public static String URL_FETCH_RECIPIENT = "http://192.168.43.137:5000/api/wallet/recipient";
    ...
    //public static String URL_TM_TRANSFER = "http://192.168.43.137:5000/api/wallet/tmtransfer";
